...
var check_for_project_frameworks = function (config) {
    var frameworks = [];
    ...
    if (exists("bower.json"))
        frameworks.push("bower");
    if (exists("Gemfile"))
        frameworks.push("bundler");
    if (exists(".editorconfig"))
        frameworks.push("editorconfig");
    if (exists(".retireignore"))
        frameworks.push("retirejs");
    if (exists(".eslintrc") ||
        exists(".eslintrc.yml") ||
    ...
    if (exists(".rubocop.yml"))
        frameworks.push("rubocop");
    if (exists(".slim-lint.yml"))
        frameworks.push("slim-lint");
    if (exists(".brakeman.yml"))
        frameworks.push("brakeman");
    if (exists(".git"))
        frameworks.push("git");
