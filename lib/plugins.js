...
var is_error_or_warn = function is_error_or_warn(issue) {
    return _.some(util.warnings.concat(util.errors), function (t) {
        return issue.type == t;
    });
};
...
var set_config_list = function set_config_list(plugin_config, key, base) {
    var list = _.get(plugin_config, key, []);
