...
var filter_plugins_to_run = function (peer_installed, via_config, via_opts, skip_core_plugins) {
...
var exec = function (config, opts) {
    ...
    var run = function (peer_installed_plugins) {
        return execute_plugins(filter_plugins_to_run(peer_installed_plugins, allowed_plugins_via_config, allowed_plugins_via_opts, opts.skip_core_plugins), config, opts);
    };
