...
var exec = function (config, opts) {
    ...
    return plugin_require
        ...
        log.debug("available modules", installed_plugins.join(", "));
        log.debug("via .ferret.yml =>", allowed_plugins_via_config.join(", "));
        log.debug("via opts =>", allowed_plugins_via_opts.join(", "));
        log.debug("via additional_opts =>", allowed_plugins_via_additional_opts.join(", "));
